...
def generate_prompt(character, setting, feeling, length, extra):
    ...
    system_prompt = (
        ...
        "Do not explicitly label the moral, but make it clear at the end. Only answer with the story. Do not include humans. Use simple language that will be understandable for children aged 6 to 11 years old. "
